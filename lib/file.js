...
File.loadConfig = function(){
	if(File.exists(path.join(__dirname,'config.json')))
		...
		File.config.mailnotify = false;
		File.config.mailhost = 'smtp.gmail.com';
		File.config.mailuser = 'me@gmail.com';
		File.config.mailpass = 'pass';
		File.config.mailaddr = 'me@gmail.com';
		File.saveConfig();
	}
}
